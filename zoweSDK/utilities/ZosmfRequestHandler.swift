...
/// z/OSMF REST API HTTP request class
internal class ZosmfRequestHandler: NSObject, URLSessionDelegate {
    
    // MARK: - ZosmfRequestHandler private members
    ...
    // MARK: - ZosmfRequestHandler internal members
    ...
    // MARK: - ZosmfRequestHandler constructor
    
    /// ZosmfRequestHandler object constructor
    /// - Parameters:
    ///   - connection: z/OSMF API connection object (generated by the ZoweSDK object)
    ...
    // MARK: - ZosmfRequestHandler internal methods
    ...
    // MARK: - ZosmfRequestHandler private methods
        ...
        if let error = error {
            ...
            if let response = response as? HTTPURLResponse {
                if let data = data, data.count > 0 {
                    ...
                    return ZosmfError.httpStatus(code: response.statusCode).errorDescription
                }
            }
        }
        return nil
